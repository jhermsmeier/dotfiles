...
set -g __fish_git_prompt_char_cleanstate '〇'
set -g __fish_git_prompt_char_dirtystate '⋮' # * ⋯ ∎
set -g __fish_git_prompt_char_stagedstate '〒'
set -g __fish_git_prompt_char_stashstate '〼'
...
set -g __fish_git_prompt_color '#696969' # 'yellow' # 'red'
...
set -g __fish_git_prompt_color_upstream '#C4C4C4'
